"""
Hatchet-specific framework task definitions.

This module creates the internal framework tasks (chain, swarm handlers)
using Hatchet's specific API. These tasks are automatically registered
...
def create_hatchet_framework_tasks(hatchet: Hatchet) -> list:
    """
    Create internal framework tasks for Hatchet.

    This function creates and registers the internal tasks needed for
    chain and swarm functionality using Hatchet's specific decorators
    and configuration options.

    Args:
        hatchet: Hatchet client instance

    Returns:
        List of registered workflow objects
    """
